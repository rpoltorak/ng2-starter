System.config({
  ...
  map: {
    ...
    "lite-server": "npm:lite-server@1.3.2",
    ...
    "npm:browser-sync-ui@0.5.17": {
      "async-each-series": "npm:async-each-series@1.1.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "connect-history-api-fallback": "npm:connect-history-api-fallback@1.1.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "http": "github:jspm/nodelibs-http@1.7.1",
    ...
    "npm:browser-sync@2.11.0": {
      "async-each-series": "npm:async-each-series@0.1.1",
      "browser-sync-client": "npm:browser-sync-client@2.4.1",
      "browser-sync-ui": "npm:browser-sync-ui@0.5.17",
      "bs-recipes": "npm:bs-recipes@1.0.5",
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "foxy": "npm:foxy@11.1.4",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "fs-extra": "npm:fs-extra@0.26.4",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "immutable": "npm:immutable@3.7.6",
      "localtunnel": "npm:localtunnel@1.8.0",
    ...
    "npm:connect-history-api-fallback@1.1.0": {
      "url": "github:jspm/nodelibs-url@0.1.0"
    },
    ...
    "npm:lite-server@1.3.2": {
      "browser-sync": "npm:browser-sync@2.11.0",
      "connect-history-api-fallback": "npm:connect-history-api-fallback@1.1.0",
      "connect-logger": "npm:connect-logger@0.0.1",
      "yargs": "npm:yargs@3.29.0"
    },
    "npm:localtunnel@1.8.0": {
      "debug": "npm:debug@2.2.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "net": "github:jspm/nodelibs-net@0.1.2",
